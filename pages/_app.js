      ...
      <div className='container-fluid'>
        ...
        <div className='col-md-2 text-white p-0' style={{backgroundColor:"#222d32", height:"100vh",position:"relative", overflow:"hidden"}}>
            ...
            <div className='my-5 mx-2' style={{fontWeight:"700"}}>
              IF ERROR FOR ANY REASON PLS RELOAD <br/> <br/> <br/>
              <a href='https://forms.gle/X8cDNi6GqUYnAhs27' target='_blank' rel="noreferrer" 
              style={{textDecoration:'none', padding:"10px 15px",borderRadius:"25px", background:"White", color:"blue",fontSize:"16px"}}>
                Feedback 
              </a>
            </div> 
          </div>
